...
SwipeIt.prototype.ontouchmove = function (e) {
  ...
  this.moving = true
  if (!this.clientX) this.clientX = touch.clientX
...
SwipeIt.prototype.disalbe = function () {
  this._disabled = true
  this.reset()
}

SwipeIt.prototype.enable = function () {
 ...
 * @return {promise}
 */
SwipeIt.prototype.remove = function (duration, ease) {
  if (this.stat === 'reseting') return
  var el = this.holder
