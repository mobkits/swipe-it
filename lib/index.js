...
/**
 * Remove the swiped element and related holder with transition specified by `duration` (default 300) in millisecond and `ease` timing function (default ease-out)
 *
 * @public
 * @param {Number} duration
 * @param {String} ease
